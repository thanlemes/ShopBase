...
<head>
    <meta charset="UTF-8">
    <title>Excluir Produto - ShopBase</title>
...
<div class="container">
    <div class="card shadow-sm mx-auto text-center" style="max-width: 500px;">
        <div class="card-body">
            <h1 class="text-primary mb-4">Excluir Produto</h1>
            <% if (metodoPost) { %>
                <div class="alert <%= sucesso ? "alert-success" : "alert-danger" %>" role="alert">
                    <%= sucesso ? "Produto excluído com sucesso!" : "Erro ao excluir o produto." %>
                </div>
            <% } else { %>
