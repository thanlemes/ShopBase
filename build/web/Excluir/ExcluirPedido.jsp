...
<head>
    <meta charset="UTF-8">
    <title>Excluir Pedido - ShopBase</title>
...
<div class="container">
    <div class="card shadow-sm mx-auto text-center" style="max-width: 500px;">
        <div class="card-body">
            <h1 class="text-primary mb-4">Excluir Pedido</h1>
            <% if (metodoPost) { %>
                <div class="alert <%= sucesso ? "alert-success" : "alert-danger" %>" role="alert">
                    <%= sucesso ? "Pedido excluído com sucesso!" : "Erro ao excluir o pedido." %>
                </div>
            <% } else { %>
            ...
            <% } %>
            <a href="../views/Pedidos.jsp" class="btn btn-primary mt-3">Voltar</a>
        </div>
    </div>
</div>
